  ...
  return (
    <div className="grid min-h-screen lg:grid-cols-2">
      ...
      <div className="relative hidden flex-col justify-between overflow-hidden border-r border-white/10 bg-navy-900 p-12 lg:flex">
        ...
        <div className="pointer-events-none absolute -left-24 top-1/3 h-96 w-96 rounded-full bg-teal-500/15 blur-3xl" />
        <div className="pointer-events-none absolute -right-24 bottom-0 h-96 w-96 rounded-full bg-medical-600/20 blur-3xl" />
        ...
        <div className="relative max-w-md">
          <h2 className="text-3xl font-bold leading-tight tracking-tight text-white">
            Create your {BRAND.name} clinical workspace.
          </h2>
          <p className="mt-4 text-slate-400">
            Set up a secure, role-based account to upload studies and reports, view DICOM,
            and run privacy-first clinical workflows.
          </p>
      ...
      {/* Right — real Clerk sign-up (with email verification) */}
