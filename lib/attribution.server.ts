 ...
 *   2. VISIBLE CREDIT  — the app footer must still render that credit.
 *
...
────────────────────────────────────────────────────────────────────────
  ...
  Restore the credit in the app footer and the app will start.

  Everything around it is still yours: rename it, restyle it, change the
  branding. Sell it. Keep the money. Just leave the one line that says who
  built it.
────────────────────────────────────────────────────────────────────────
`;
